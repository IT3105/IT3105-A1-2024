...
- have to move the folder inside the packages, src contains Appdev, functionality wise no movie details just the title

  Functionality & Features (15/20)
  Code Quality & Best Practices (10/20) // app folder structure not good
  Implementation of Development Tools (8/15)
  User Interface (UI) & User Experience (UX) (10/15)
  Use of Libraries/Frameworks (20/20)
  Task Completion & Time Management (5/10) // very late
  TOTAL 68
