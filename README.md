...
- should be vanilla java script you are using a framework for this, not following instructions!
  Functionality & Features (1/20)
  Code Quality & Best Practices (1/20)
  Implementation of Development Tools (1/15)
  User Interface (UI) & User Experience (UX) (15/15)
  Use of Libraries/Frameworks (0/20)
  Task Completion & Time Management (10/10)
  TOTAL 28
