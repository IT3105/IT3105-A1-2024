...
- able to have the date subcribed greater than the renewal date
- when selecting for horizontal layout, profile, lock-screen, logout it redirects me to a non existing page

  Functionality & Features (12/20) // many unnecessary non working 'features' shown
  Code Quality & Best Practices (10/20) // bloated for a simple application
  Implementation of Development Tools (15/15)
  User Interface (UI) & User Experience (UX) (15/15)
  Use of Libraries/Frameworks (15/20)
  Task Completion & Time Management (5/10) //very late submission
  TOTAL 72
