...
- functionality/features not working
  ...
  Code Quality & Best Practices (10/20) // buggy
  Implementation of Development Tools (7/15) // have to edit to make it work
  User Interface (UI) & User Experience (UX) (12/15)
